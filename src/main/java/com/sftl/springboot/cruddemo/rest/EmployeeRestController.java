package com.sftl.springboot.cruddemo.rest;
...
import com.sftl.springboot.cruddemo.service.EmployeeService;
...
public class EmployeeRestController {
	...
	public Employee addEmployee(@RequestBody Employee theEmployee) {
		...
		theEmployee.setId(0);
		employeeService.saveEmploye(theEmployee);
		return theEmployee;
	...
	//add mapping for DELET /employees/{employeeId} -delete employee
